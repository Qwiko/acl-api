...
def upgrade() -> None:
    ...
    op.create_table('dynamic_policies',
    ...
    op.create_table('dynamic_policy_destination_filter_association',
    sa.Column('dynamic_policy_id', sa.Integer(), nullable=False),
    sa.Column('network_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['dynamic_policy_id'], ['dynamic_policies.id'], ),
    sa.ForeignKeyConstraint(['network_id'], ['networks.id'], ),
    sa.PrimaryKeyConstraint('dynamic_policy_id', 'network_id')
    )
    op.create_table('dynamic_policy_source_filter_association',
    sa.Column('dynamic_policy_id', sa.Integer(), nullable=False),
    sa.Column('network_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['dynamic_policy_id'], ['dynamic_policies.id'], ),
    sa.ForeignKeyConstraint(['network_id'], ['networks.id'], ),
    ...
    op.create_table('network_addresses',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('network_id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.ForeignKeyConstraint(['nested_network_id'], ['networks.id'], ),
    sa.ForeignKeyConstraint(['network_id'], ['networks.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.ForeignKeyConstraint(['nested_policy_id'], ['policies.id'], ),
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.CheckConstraint('(policy_id IS NOT NULL OR dynamic_policy_id IS NOT NULL) AND NOT (policy_id IS NOT NULL AND dynamic_policy_id IS NOT NULL)', name='check_policy_or_dynamic_policy_only_one'),
    sa.ForeignKeyConstraint(['dynamic_policy_id'], ['dynamic_policies.id'], ),
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.ForeignKeyConstraint(['nested_service_id'], ['services.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    op.create_table('target_dynamic_policy_association',
    ...
    op.create_table('target_policy_association',
    sa.Column('target_id', sa.Integer(), nullable=False),
    sa.Column('policy_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], ),
    sa.ForeignKeyConstraint(['target_id'], ['targets.id'], ),
    ...
    op.create_table('test_dynamic_policy_association',
    sa.Column('test_id', sa.Integer(), nullable=False),
    sa.Column('dynamic_policy_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['dynamic_policy_id'], ['dynamic_policies.id'], ),
    sa.ForeignKeyConstraint(['test_id'], ['tests.id'], ),
    ...
    op.create_table('test_policy_association',
    sa.Column('test_id', sa.Integer(), nullable=False),
    sa.Column('policy_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], ),
    sa.ForeignKeyConstraint(['test_id'], ['tests.id'], ),
    ...
    op.create_table('policy_term_destination_network_association',
    sa.Column('policy_term_id', sa.Integer(), nullable=False),
    sa.Column('network_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['network_id'], ['networks.id'], ),
    sa.ForeignKeyConstraint(['policy_term_id'], ['policy_terms.id'], ),
    sa.PrimaryKeyConstraint('policy_term_id', 'network_id')
    )
    op.create_table('policy_term_destination_service_association',
    sa.Column('policy_term_id', sa.Integer(), nullable=False),
    sa.Column('service_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['policy_term_id'], ['policy_terms.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    ...
    op.create_table('policy_term_source_network_association',
    sa.Column('policy_term_id', sa.Integer(), nullable=False),
    sa.Column('network_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['network_id'], ['networks.id'], ),
    sa.ForeignKeyConstraint(['policy_term_id'], ['policy_terms.id'], ),
    ...
    op.create_table('policy_term_source_service_association',
    sa.Column('policy_term_id', sa.Integer(), nullable=False),
    sa.Column('service_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['policy_term_id'], ['policy_terms.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    ...
    op.create_table('revision_configs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
